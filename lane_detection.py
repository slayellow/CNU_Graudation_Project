...
class Lane(object):
    ...
    def process_frame(self, image):
        ...
        # RoI 범위설정 하는 부분
        # 이부분을 통해 차선 따는 범위를 설정할 수 있다.
        imshape = image.shape
        lower_left = [imshape[1]/9,imshape[0]]
        lower_right = [imshape[1]-imshape[1]/9,imshape[0]]
        top_left = [imshape[1]/2-imshape[1]/8,imshape[0]/2+imshape[0]/12]
        top_right = [imshape[1]/2+imshape[1]/8,imshape[0]/2+imshape[0]/12]
...
clip1 = VideoFileClip("000006.mp4")
